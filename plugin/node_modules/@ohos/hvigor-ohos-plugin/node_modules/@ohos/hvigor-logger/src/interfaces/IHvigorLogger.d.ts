import { MergeKeyEnum } from '../consts/ErrorLogConsts.js';
import { MergeOption } from './MergeOption.js';
/**
 * hvigor进行控制台打印的类，整个构建系统一起使用。
 */
export interface IHvigorLogger {
    /**
    ...
    /**
     * 【不阻塞构建】收集错误信息到数组，用于printMergedError或者printAllError
     * @param error
     */
