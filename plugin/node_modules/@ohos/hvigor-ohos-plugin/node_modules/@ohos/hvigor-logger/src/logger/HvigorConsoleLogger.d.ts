import { MergeKeyEnum, SubSystemEnum } from '../consts/ErrorLogConsts.js';
import { IHvigorLogger } from '../interfaces/IHvigorLogger.js';
import { MergeOption } from '../interfaces/MergeOption.js';
/**
 * hvigor进行控制台及日志文件打印的类，非rollup系统使用。
 * 打印模块的主入口，接受HvigorErrorInfo，提供打印函数。
 */
export declare class HvigorConsoleLogger implements IHvigorLogger {
    private subSystem;
    private hvigorErrorCommonAdapter;
    private hvigorLogList;
    constructor(subSystem: SubSystemEnum | string);
    /**
     * 【不阻塞构建】打印一个错误信息到控制台，使用方可以传一个纯对象
     * @param error
     */
     ...
     * @param error
     */
    printErrorAndExit(error: any): void;
    /**
     * 【不阻塞构建】打印一个告警信息到控制台
     * @param warn
     */
     ...
     */
    printAllError(errorList?: any[]): void;
    /**
