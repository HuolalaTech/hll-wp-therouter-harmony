import { HvigorLogger } from '../logger/HvigorLogger.js';
export declare class LogPathUtil {
    private static HVIGOR_PROJECT_ROOT_DIR;
    private static HVIGOR_USER_HOME_DIR_NAME;
