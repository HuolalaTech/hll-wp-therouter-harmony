...
export declare class CoverageInstrumenter extends BaseInstrumenter {
    ...
    constructor(context: ts.TransformationContext, sourceFile: ts.SourceFile, projectConfig: Config, projectPath: string);
    ...
    private isInvalidEntryNodeBody;
    /**
